...
const styleIcon =
  "block absolute text-2xl sm:text-4xl md:hidden  hover:text-5xl ";
const styleName = "hidden  md:block font-bold lg:text-lg";

export default function ServiceNavBar() {
  return (
    <div className="mt-1 static h-[fit-content] w-[90%] bg-red-900 text-white mb-0 mx-auto rounded-full ">
        ...
        <div className="w-30 h-20 p-6 flex ">
          <li className={styleList}>
            ...
            <span className={styleName}>
              <Link to="/wasna-bakers">Wasana Bakers</Link>
            </span>
          ...
          <li className={styleList}>
            ...
            <span className={styleName}>
              <Link to="/wasana-gimanhala">Gimanhala</Link>
            </span>
          ...
          <li className={styleList}>
            ...
            <span className={styleName}>
              <Link to="/wasna-reception-hall">Reception Hall</Link>
            </span>
          ...
          <li className={styleList}>
            ...
            <span className={styleName}>
              <Link to="#">Clean & Care Service</Link>
            </span>
          </li>
          <li className={styleList}>
            {" "}
            ...
            <span className={styleName}>
              <Link to="#">Builders & Engineers</Link>
            </span>
          </li>
        </div>
        {/*  */}
