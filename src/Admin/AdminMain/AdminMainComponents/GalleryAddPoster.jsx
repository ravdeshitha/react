...
function GalleryAddPoster({setIsAddPoster}) {
    ...
    const handleAddPoster = async (e) =>{
        ...
        try{
            ...
            await axios.post('https://test-repo-2xuo.onrender.com/api/adminBoard/main/poster', formData, {withCredentials: true})
            .then(res =>{
        ...
        <div className='w-full h-[46vh] pl-5 pt-2 pr-4'>
            ...
            <div className='flex w-full gap-7'>
                <div className='relative w-[28%] h-[35vh] rounded-lg border-dotted border-gray-700 border-[3px] flex flex-col justify-center items-center'>
                    <input type='file' className='absolute w-full h-full opacity-0' onChange={handleImageChange}/>
        ...
        <div className='w-full h-[10vh] bg-slate-700 flex items-start justify-end'>
            <div className='w-[60%] flex gap-5 mr-10 items-center'>
                ...
                <div className='galField mt-0'>
                    ...
                    <select className='galInput w-80 bg-slate-200/70 galselection' name='albumId' value={posterData.albumId} onChange={handleChange}>
                ...
                <button className='w-20 h-8 bg-slate-200 mt-5 rounded-md font-bold' type='submit' onClick={handleAddPoster}>
                    ADD
                </button>
                </div>
            </div>
